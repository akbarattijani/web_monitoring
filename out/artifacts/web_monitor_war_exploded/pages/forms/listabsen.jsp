                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Select attendance date to show Maps</h3>
                                </div>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <%
                                            ...
                                            for (int d = 0; d < array.length(); d++) {
                                                ...
                                                %>
                                                <tr>
                                                    <td> <a href="/DashboardController?type=4&nip=${nip}&name=${name}&assign=<%= object.getInt("id")%>"><%= object.getString("start_date") %></a></td>
                                                    <td><%= object.getString("break_start_date") %></td>
                                                    <td><%= object.getString("break_end_date") %></td>
                                                    <td><%= object.getString("end_date") %></td>
                                                </tr>
                                                <%
                                            }
                                        %>
